...
#admin account
admin = User.create(fname: 'Admin', lname: 'Admin', email:'admin@bolend.com',"password":"123","phonenum":"416666666", "address":"123 fake street","email_confirmed":"true",  admin: true)
