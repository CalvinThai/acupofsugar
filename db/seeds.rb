...
#admin account
User.create!(fname: 'Admin', lname: 'Admin', email:'admin@anymail.com',password:'adminpass',phonenum: '416666666', address:'123 fake street',email_confirmed: true,  admin: true)
